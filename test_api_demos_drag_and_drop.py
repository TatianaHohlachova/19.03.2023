...
class TestApiDemos(unittest.TestCase):
    def setUp(self):
        ...
        caps["appium:deviceName"] = "localhost:c"
    ...
    def test_api_demos_3_drag_and_drop(self):
        ...
        actions_dnd.pause(10)
        self.driver.save_screenshot("C:\\Users\\vdi-student\\screenshot\\screenshot.png")
        actions_dnd.move_to_element(dot_2)
        actions_dnd.release()
        #actiond.dnd.drag_and_drop(dot1, dot2)
        actions_dnd.perform()
